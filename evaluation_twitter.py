...
emoint_df = pd.read_csv('data/cleaned_data/emoint_test_sample.csv', index_col=0)
...
def main():
    ...
    with open('emoint_val_predicted_list.pkl', 'wb') as f:
        pickle.dump(predicted_list, f)

    with open('emoint_val_label_list.pkl', 'wb') as f:
